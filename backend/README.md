...
## Project Structure
    ...
    ├── testapiautosettings_55205  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_55205`
...
2. Clone this repo and `cd testapiautosettings_55205`
